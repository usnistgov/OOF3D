...
// --------------------------------------------------------------------------------
// $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/SWIG/naming.cxx,v 1.1.2.2 2014/06/27 20:28:29 langer Exp $
//
// naming.cxx
//
// SWIG naming service.
...
// --------------------------------------------------------------------------------
// char *name_getformat(const char *method)
//
...
static char *name_getformat(const char *method) {
...
// --------------------------------------------------------------------------------
// char *name_wrapper(char *fname, const char *prefix, int suppress)
//
...
char *name_wrapper(const char *fname, const char *prefix, int suppress) {
  static String fmt;
  const char   *f;
...
char *name_member(const char *fname, char *classname, int suppress) {
  static String fmt;
  const char   *f;
...
char *name_construct(const char *classname, int suppress) {
  static String fmt;
  const char   *f;
...
char *name_destroy(const char *classname, int suppress) {
  static String fmt;
  const char   *f;
