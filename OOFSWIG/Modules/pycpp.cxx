...
/**********************************************************************
 * $Header: /users/langer/FE/CVSoof/OOF2/OOFSWIG/Modules/pycpp.cxx,v 1.1.2.2 2014/06/27 20:28:07 langer Exp $
 *
 * pycpp.cxx
 *
...
void PYTHON::cpp_open_class(char *classname,const char *rname, char *ctype, int strip) {
...
void PYTHON::cpp_member_func(char *name, const char *iname, DataType *t, ParmList *l) {
...
void PYTHON::cpp_constructor(char *name,const char *iname, ParmList *l) {
  const char *realname;
  Parm *p;
  int   i;
...
void PYTHON::cpp_destructor(char *name,const char *newname) {
  const char *realname;
  int oldshadow = shadow;
...
void PYTHON::cpp_variable(char *name,const char *iname, DataType *t) {
  const char *realname;
  int   inhash = 0;
  int   oldshadow = shadow;
  String cname = "python:";
...
void PYTHON::cpp_declare_const(const char *name,const char *iname, DataType *type,const char *value) {
  const char *realname;
  int   oldshadow = shadow;
  String cname = "python:";
