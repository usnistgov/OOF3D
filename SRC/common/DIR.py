...
def set_clib_flags(clib):
    ...
    if DIM_3:
        ...
        vtkLib('vtkCommonCore')
        vtkLib('vtkCommonDataModel')
        vtkLib('vtkCommonExecutionModel')
        vtkLib('vtkCommonMisc')
        vtkLib('vtkCommonTransforms')
        vtkLib('vtkFiltersCore')
        vtkLib('vtkFiltersExtraction')
        vtkLib('vtkFiltersGeneral')
        vtkLib('vtkFiltersModeling')
        vtkLib('vtkFiltersSources')        
        vtkLib('vtkIOImage')
        vtkLib('vtkIOXML')
        vtkLib('vtkImagingCore')
        vtkLib('vtkRenderingAnnotation')
        vtkLib('vtkRenderingCore')
        vtkLib('vtkRenderingContextOpenGL2')
        vtkLib('vtkRenderingOpenGL2')
        vtkLib('vtkRenderingVolumeOpenGL2')
        vtkLib('vtkRenderingFreeType')
