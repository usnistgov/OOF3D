...
def set_clib_flags(clib):
    ...
    if DIM_3:
        clib.externalLibs.append('vtkCommonCore-7.1')
        clib.externalLibs.append('vtkCommonDataModel-7.1')
        clib.externalLibs.append('vtkCommonExecutionModel-7.1')
        clib.externalLibs.append('vtkCommonMisc-7.1')
        clib.externalLibs.append('vtkCommonTransforms-7.1')
        clib.externalLibs.append('vtkFiltersCore-7.1')
        clib.externalLibs.append('vtkFiltersExtraction-7.1')
        clib.externalLibs.append('vtkFiltersGeneral-7.1')
        clib.externalLibs.append('vtkFiltersModeling-7.1')
        clib.externalLibs.append('vtkFiltersSources-7.1')        
        clib.externalLibs.append('vtkIOImage-7.1')
        clib.externalLibs.append('vtkIOXML-7.1')
        clib.externalLibs.append('vtkImagingCore-7.1')
        clib.externalLibs.append('vtkRenderingAnnotation-7.1')
        clib.externalLibs.append('vtkRenderingCore-7.1')
        clib.externalLibs.append('vtkRenderingContextOpenGL2-7.1')
        clib.externalLibs.append('vtkRenderingOpenGL2-7.1')
        clib.externalLibs.append('vtkRenderingVolumeOpenGL2-7.1')
        clib.externalLibs.append('vtkRenderingFreeType-7.1')
