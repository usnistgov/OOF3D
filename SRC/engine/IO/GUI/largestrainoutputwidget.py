...
from ooflib.SWIG.engine import largestrainoutput
...
class LSPTypeWidget(regclassfactory.RegisteredClassFactory,
    ...
    def __init__(self, value, scope, name, verbose=False):
        regclassfactory.RegisteredClassFactory.__init__(
            self, largestrainoutput.LargeStrainType.registry, obj=value,
...
largestrainoutput.LargeStrainTypeParameter.makeWidget = _makeLargeStrainTypeParameterWidget
