...
swigfiles = [
    ...
    'csnapnodes.swg', 'csnaprefine.swg',
    'crationalizers.swg', 'elementshape.swg',
    'angle2color.swg', 'bdyanalysis.swg', 'boundarycond.swg', 'cconjugate.swg', 
    'compoundsubproblem.swg', 'contourcell.swg', 'cstrain.swg',
    ...
    'pixelselectioncouriere.swg', 'planarity.swg',
    'pointdata.swg',
...
pyfiles = [
    ...
    'symstate.py', 'timestepper.py', 'twostep.py', 'preconditioner.py'
]
...
hfiles = [
    ...
    'cmatrixmethods.h',
    'compoundsubproblem.h', 'constraint.h',
    'contourcell.h', 'cscpatch.h', 
    'cstrain.h', 'csubproblem.h',
    'dofmap.h', 'edge.h', 
    ...
    'fluxnormal.h', 'freedom.h', 'gausspoint.h',
    ...
    'predicatesubproblem.h', 'property.h',
