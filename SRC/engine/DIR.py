...
cfiles = [
    ...
    'deformation.C','largestrainoutput.C',
...
swigfiles = [
    ...
    'csubproblem.swg', 
    'deformation.swg','largestrainoutput.swg',
    'diagpre.swg', 'dofmap.swg', 'edge.swg', 
...
pyfiles = [
    ...
    'edgeswap.py', 'errorestimator.py', 'euler.py', 'incremental.py', 
    'iterationmanager.py',
...
swigpyfiles = [
    ...
    'csubproblem.spy', 
    'deformation.spy','largestrainoutput.spy',
    'edge.spy', 'edgeset.spy',
...
hfiles = [
    ...
    'deformation.h','largestrainoutput.h',
    'diagpre.h', 'dofmap.h', 'edge.h', 
