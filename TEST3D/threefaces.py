...
OOF.Graphics_1.Settings.Camera.View(view=View(cameraPosition=Coord(-7.32641,7.86392,31.3801), focalPoint=Coord(5,5,5), up=Coord(0.000351236,0.994176,-0.107767), angle=30, clipPlanes=[], invertClip=0, size_x=691, size_y=652))
