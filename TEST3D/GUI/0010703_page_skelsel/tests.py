...
def sensitization0():
    return (sensitizationCheck({'New': 1,
                               ...
                               base="OOF3D:Skeleton Selection Page:Pane:Groups")
            and
            historySensitizationCheck('Segment', prev=0, ok=0, next=0)
            and
            sensitizationCheck({'Undo' : 0,
                               ...
                               base="OOF3D:Skeleton Selection Page:Pane:Selection")
            )
