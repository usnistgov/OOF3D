...
def SetTimeStepperDialogCheck(methods=None, method=None, errorscalling=None, stepper=None):
    okbutton = gtklogger.findWidget('Dialog-Specify Solver:gtk-ok')
    return ((okbutton.get_property('sensitive') == True) and
	   chooserCheck('Dialog-Specify Solver:solver_mode:Advanced:time_stepper:Chooser', methods) and
           chooserCheck('Dialog-Specify Solver:solver_mode:Advanced:time_stepper:'+method+':errorscaling:Chooser', errorscalling) and
           chooserCheck('Dialog-Specify Solver:solver_mode:Advanced:time_stepper:'+method+':stepper:Two Step:singlestep:Chooser', stepper))
           
           
def SetTimeStepperDialogSelect(method=None, errorscalling=None, stepper=None):
    okbutton = gtklogger.findWidget('Dialog-Specify Solver:gtk-ok')
    return ((okbutton.get_property('sensitive') == True) and
	   chooserStateCheck('Dialog-Specify Solver:solver_mode:Advanced:time_stepper:Chooser', method) and
           chooserStateCheck('Dialog-Specify Solver:solver_mode:Advanced:time_stepper:'+method+':errorscaling:Chooser', errorscalling) and
           chooserStateCheck('Dialog-Specify Solver:solver_mode:Advanced:time_stepper:'+method+':stepper:Two Step:singlestep:Chooser', stepper))
