...
def microstructureListCheck(*mcrs):
    return chooserCheck('OOF3D:Microstructure Page:Microstructure',mcrs)
...
def layersNumberCheck():
  return treeViewSizeCheck('OOF3D Graphics 1:Pane0:LayerScroll:LayerList')
...
def sensitization3(): # selected non-empty group, selected pixels
    return sensitizationCheck(
        {'New' : 1,
         'Rename' : 1,
         'Copy' : 1,
