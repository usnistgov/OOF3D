...
def FEMeshPageSubproblemsCheck2():
    return sensitizationCheck({ 'Pane:Subproblems:New':1,
				'Pane:Subproblems:Rename':1,
				'Pane:Subproblems:Edit':1,
				'Pane:Subproblems:Copy':1,
				'Pane:Subproblems:Info':1,
				'Pane:Subproblems:Delete':1
				},
			       base='OOF3D:FE Mesh Page')
...
def FEMeshPageOperationsCheck2():
    return sensitizationCheck({ 'Pane:ElementOps:Method':1,
				'Pane:ElementOps:Prev':1,
				'Pane:ElementOps:OK':1,
				'Pane:ElementOps:Next':0
				},
			       base='OOF3D:FE Mesh Page')
			       
def FEMeshPageOperationsCheck3():
    return sensitizationCheck({ 'Pane:ElementOps:Method':1,
				'Pane:ElementOps:Prev':0,
				'Pane:ElementOps:OK':1,
				'Pane:ElementOps:Next':1
				},
			       base='OOF3D:FE Mesh Page')
			       
def FEMeshPageOperationsCheck4():
    return sensitizationCheck({ 'Pane:ElementOps:Method':1,
				'Pane:ElementOps:Prev':1,
				'Pane:ElementOps:OK':1,
				'Pane:ElementOps:Next':1
