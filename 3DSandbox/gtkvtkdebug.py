...
if __name__ == "__main__":
    ...
    #coneActor.SetOrigin(110,110,110)
    ren = vtk.vtkRenderer()
...
##     #vtkda.GetRenderWindow().AddRenderer(ren)
    ...
    #image.Update()
    #image.GetPointData().GetScalars().FillComponent(3,50)
    image.Update()
    #print image.GetNumberOfScalarComponents()
    #print image.GetPointData().GetScalars().GetNumberOfComponents()
    #print image.GetScalarComponentAsFloat(3,3,3,3)
...
#     scalaropacity.AddSegment(0,0,255,.5)
#     volproperty.SetScalarOpacity(3,scalaropacity)
#     #gradientopacity = vtk.vtkPiecewiseFunction()
#     #gradientopacity.AddSegment(0,1,1024,1)
#     #volproperty.SetGradientOpacity(3,gradientopacity)
#     volproperty.DisableGradientOpacityOn(3)
#     #volproperty.SetScalarOpacityUnitDistance(3,100)

    print "independent components: ", volproperty.GetIndependentComponents()
    for i in xrange(4):
        print i, volproperty.GetColorChannels(i)
        #print volproperty.GetRGBTransferFunction(i)
        #print volproperty.GetScalarOpacity(i)
