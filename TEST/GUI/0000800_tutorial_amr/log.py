...
findMenu(findWidget('Adaptive Mesh Refinement:MenuBar'), 'Windows:Graphics:New').activate()
...
findWidget('Adaptive Mesh Refinement:Next').clicked()
findWidget('Adaptive Mesh Refinement:Next').clicked()
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 2.5454545454545e+00)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 2.8000000000000e+01)
findWidget('Adaptive Mesh Refinement:Next').clicked()
...
# checkpoint Move Node toolbox writable changed
# checkpoint Graphics_1 Move Nodes sensitized
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 1.2727272727273e+00)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 2.8000000000000e+01)
findWidget('Adaptive Mesh Refinement:Next').clicked()
...
findWidget('Adaptive Mesh Refinement').resize(500, 300)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 2.2173913043478e+00)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 2.0178260869565e+02)
findWidget('Adaptive Mesh Refinement:TutorialScroll').get_vadjustment().set_value( 2.0400000000000e+02)
setComboBox(findWidget('OOF2:FE Mesh Page:Pane:ElementOps:Method:Chooser'), 'Adaptive Mesh Refinement')
checkpoint mesh page sensitized
checkpoint mesh page subproblems sensitized
findWidget('OOF2:FE Mesh Page:Pane:ElementOps:OK').clicked()
findWidget('OOF2 Messages 1').resize(559, 200)
findWidget('OOF2 Graphics 1:Pane0').set_position(278)
checkpoint mesh page subproblems sensitized
checkpoint mesh page subproblems sensitized
checkpoint Graphics_1 Skeleton Info sensitized
...
canvasobj.emit('event', event(gtk.gdk.BUTTON_PRESS,x= 3.0217391304348e+00,y=-2.7173913043478e+00,state=1,window=findCanvasGdkWindow('Graphics_1')))
canvasobj = findCanvasRoot(findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas'), windowname='Graphics_1')
canvasobj.emit('event', event(gtk.gdk.MOTION_NOTIFY,x= 3.0217391304348e+00,y=-2.8478260869565e+00,state=257,window=findCanvasGdkWindow('Graphics_1')))
canvasobj = findCanvasRoot(findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas'), windowname='Graphics_1')
canvasobj.emit('event', event(gtk.gdk.BUTTON_RELEASE,x= 3.0217391304348e+00,y=-2.8478260869565e+00,state=257,window=findCanvasGdkWindow('Graphics_1')))
findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas:vscroll').get_adjustment().set_value( 6.3000000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas:vscroll').get_adjustment().set_value( 8.8000000000000e+01)
checkpoint OOF.Graphics_1.Settings.Zoom.InFocussed
canvasobj = findCanvasRoot(findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas'), windowname='Graphics_1')
canvasobj.emit('event', event(gtk.gdk.BUTTON_PRESS,x= 3.3260869565217e+00,y=-2.8478260869565e+00,state=1,window=findCanvasGdkWindow('Graphics_1')))
canvasobj = findCanvasRoot(findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas'), windowname='Graphics_1')
canvasobj.emit('event', event(gtk.gdk.MOTION_NOTIFY,x= 3.3260869565217e+00,y=-2.8768115942029e+00,state=257,window=findCanvasGdkWindow('Graphics_1')))
canvasobj = findCanvasRoot(findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas'), windowname='Graphics_1')
canvasobj.emit('event', event(gtk.gdk.BUTTON_RELEASE,x= 3.3260869565217e+00,y=-2.8768115942029e+00,state=257,window=findCanvasGdkWindow('Graphics_1')))
findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas:hscroll').get_adjustment().set_value( 1.4000000000000e+02)
findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas:vscroll').get_adjustment().set_value( 1.9500000000000e+02)
checkpoint OOF.Graphics_1.Settings.Zoom.InFocussed
findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas:hscroll').get_adjustment().set_value( 4.3000000000000e+01)
findWidget('OOF2 Graphics 1:Pane0:Pane1:Pane2:Canvas:vscroll').get_adjustment().set_value( 2.1900000000000e+02)
